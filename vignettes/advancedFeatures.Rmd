...
If a file currently exists, it will not be overwritten. After this process has run, this file can be recalled and passed to the ```BayesianOptimization``` function in the ```leftoff``` parameter:  
```{r eval = FALSE, results='hide', echo=TRUE}
